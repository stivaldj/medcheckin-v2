...
| Tarefa                               | Como                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Aplicar migrations                   | **Produção:** automático — o serviço `migrate` do `docker-compose.prod.yml` roda a cada `up -d --build`, e `web`/`scheduler` só sobem se ele terminar bem (ver `docs/DEPLOY.md` §9). Conferir: `docker compose -p medcheckin -f docker-compose.prod.yml --env-file .env.prod logs migrate`. **Dev:** `npm run migrate` (idempotente). |
