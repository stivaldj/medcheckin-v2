...
| Ajuda contínua                  | Botão **"Preciso de ajuda"** em `/p/hoje` reabre o passo que falta (ou refaz o teste). `NoSession` ganha instrução "abra o QR/WhatsApp da clínica de novo".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
